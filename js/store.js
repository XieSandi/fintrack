...
export const isCreditAccount = (acct) => calc.isCreditAccount(acct);
export const creditUsed = (acct, balances) => calc.creditUsed(acct, balances);
export const creditRemaining = (acct, balances) => calc.creditRemaining(acct, balances);
export const totalCreditDebtIDR = () => calc.totalCreditDebtIDR(state);
...
export const includeReceivablesSetting = () => calc.includeReceivablesSetting(state);
export const totalDebtIDR = () => calc.totalDebtIDR(state);
export const isDebtBorrow = (t) => calc.isDebtBorrow(t);
export const debtTxDelta = (t) => calc.debtTxDelta(t);
export const debtOutstanding = (d) => calc.debtOutstanding(d);
export const activeDebts = () => calc.activeDebts(state);
...
export const netWorthFromParts = (parts, includeCapex, includeReceivables) => calc.netWorthFromParts(parts, includeCapex, includeReceivables);
export const snapshotNetWorth = (s, includeCapex, includeReceivables) => calc.snapshotNetWorth(s, includeCapex, includeReceivables);
export const netWorthComposition = (prevParts, currParts, includeCapex, includeReceivables) => calc.netWorthComposition(prevParts, currParts, includeCapex, includeReceivables);
